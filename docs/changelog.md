...
| patch | `GET /api/v1/mock/tickets/{item_id}` | documentation only |
| patch | `GET /api/v1/mock/tickets` | documentation only |
| patch | `PUT /api/v1/mock/tickets/{item_id}` | documentation only |
| patch | `PATCH /api/v1/mock/tickets/{item_id}` | documentation only |
| patch | `GET /api/v1/preman-probe/discount` | documentation only |
| patch | `GET /api/v1/preman-probe/order-total` | documentation only |
| patch | `GET /api/v1/preman-probe/refund-status` | documentation only |
| patch | `GET /api/v1/preman-probe/shipping-estimate` | documentation only |
| patch | `POST /api/v1/projects/` | documentation only |
| patch | `POST /api/v1/projects` | documentation only |
| patch | `DELETE /api/v1/projects/{project_id}` | documentation only |
| patch | `GET /api/v1/projects/{project_id}` | documentation only |
| patch | `GET /api/v1/projects/` | documentation only |
| patch | `GET /api/v1/projects` | documentation only |
| patch | `PUT /api/v1/projects/{project_id}` | documentation only |
| patch | `PATCH /api/v1/projects/{project_id}` | documentation only |
| patch | `GET /health` | documentation only |
| patch | `POST /api/v1/projects/{project_id}/tasks` | documentation only |
| patch | `DELETE /api/v1/tasks/{task_id}` | documentation only |
| patch | `GET /api/v1/tasks/{task_id}` | documentation only |
| patch | `GET /api/v1/projects/{project_id}/tasks` | documentation only |
| patch | `PUT /api/v1/tasks/{task_id}` | documentation only |
| patch | `PATCH /api/v1/tasks/{task_id}` | documentation only |
